...
#pragma once
#ifndef _SRC_LANGS_PY_MXPY_H_
#define _SRC_LANGS_PY_MXPY_H_
...
CAPI_FUNC(bool) MxPy_TerminalInteractiveShell();
CAPI_FUNC(bool) MxPy_ZMQInteractiveShell();
