 ...
 *      Author: andy
 */
// todo: remove this file completely; it can be reintroduced in the future when tailoring the python API
//  Or! Declare some generics here that can be implemented per supported language; i.e., for python, in MxPy.h/.cpp
