...
The generated script is deposited next to this script, and is named 'mx_rtenv.yml'
...
env_output_script = 'mx_rtenv.yml'
...
class MxRTEnvParser:
    ...
    def __init__(self, argv: List[str]):
        ...
        parser = argparse.ArgumentParser(description='Mechanica runtime environment configuration')
