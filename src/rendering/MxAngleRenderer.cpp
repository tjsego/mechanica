...
const unsigned MxAngleRenderer::addClipPlaneEquation(const Magnum::Vector4& pe) {
...
const unsigned MxAngleRenderer::removeClipPlaneEquation(const unsigned int &id) {
