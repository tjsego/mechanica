...
mx.Logger.enableConsoleLogging(mx.Logger.TRACE)


def plot_glj(r0, e=1, rr0=1, _m=2, n=3):
    p = mx.Potential.glj(e=e, r0=rr0, m=_m, n=n, min=0.01, max=10)
...
def plot_glj2(r0, e=1, rr0=1, _m=2, n=3):
    ...
    p = mx.Potential.glj(e=30, m=4, n=2, max=10)
...
def plot_glj3(r0, e=1, rr0=1, _m=2, n=3):
    ...
    p = mx.Potential.glj(e=1, r0=1, m=3, k=0, min=0.1, max=1.5 * 20, tol=0.1)
...
# p = pb = mx.Potential.glj(e=0.00001, r0=0.1, mx=3, min=0.01, max=radius*3)
